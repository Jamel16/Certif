...
puts "Creating posts"
puts "Creating user"
user1 = User.new(nickname: "titi", password: "azerty", email: "titi@gmail.com")
user1.save!

user2 = User.new(nickname: "toto", password: "azerty", email: "toto@gmail.com")
user2.save!

user2 = User.new(nickname: "tata", password: "azerty", email: "tata@gmail.com")
user2.save!
